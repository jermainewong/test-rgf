...
<?php
  $var = array(
    ...
    , 2070 => array('7', '/7-mb-login.html', 'MB Login Page', 'Hosted by Avature')
    ...
    , 2130 => array('13', '/13-mb-password.html', 'MB Success reset password Page', 'Hosted by Avature')
    ...
    , 2016 => array('16', '/16-mb-jobs.html', 'MB Job List1 New Jobs Page', 'http://${domain}/search')
